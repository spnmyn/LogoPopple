package com.example.administrator.logopopple;
...
public class Wave extends View {
    ...
    private int mWidth = DimensionUtil.dip2px(getContext(), 50);
    private int mHeight = DimensionUtil.dip2px(getContext(), 50);
    private Path path;
    private float currentPercent;
    private int color;
    private String text = "贴";
    private int textSize = DimensionUtil.sp2px(getContext(), 25);
